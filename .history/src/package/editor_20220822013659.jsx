...
export default defineComponent({
    ...
    setup(props, ctx) {
        ...
        // 实现获取焦点
        let { blockMousedown, focusData, containerMousedown, lastSelectBlock } = useFocus(data, previewRef,(e) => {
            //获取焦点后进行拖拽
            mousedown(e)
        });
        //实现组件拖拽
        ...
        const buttons = [
            ...
            {label:()=>previewRef.value?'编辑':'预览', icon:()=>previewRef.value?'icon-edit':'icon-preview', handler:()=>{previewRef.value=!previewRef.value}}
        ]
        ...
        return () => <div class="editor">
            ...
            <div class="editor-top">
                {buttons.map((btn,index)=>{
                    const icon=typeof btn.icon =='function'? btn.icon
